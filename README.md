...
:spiral_calendar: September - Octuber, 202  
...
* Workshop will use a github and html to develope the course.
* More details are below. If you have questions you can contact me at <alonso.otiniano.z@uni.pe>
...
* Joseps Andrade Choque [@CivicAngela](https://twitter.com/CivicAngela)
* Carlos Geraldino [@Denironyx](https://twitter.com/Denironyx)
...
Participants have to attend to past courses.
It will also be helpful if you know good the pipe (`%>%`), double colon (`::`) and how to extract pieces of a list with `[[ ]]`. A little {ggplot2} is helpful and require.
